    ...
    return (
        ...
        <div className="text-center mt-[0.4cm]">
            <div className="text-center m-[0.4cm]" style={{display:"inline-block"}}>
                ...
                {ultBalance ? (<div className="text-[#aaa]">{Intl.NumberFormat().format(parseFloat(ultBalance).toFixed(10))} ULT</div>) : (<span></span>)}
            </div>
            <div className="text-center m-[0.4cm]" style={{display:"inline-block"}}>
            ...
            <div className="text-center m-[0.4cm]" style={{display:"inline-block"}}>
                ...
                {userETHBalance ? (<div className="text-[#aaa]">{parseFloat(userETHBalance).toFixed(10)} ETH</div>) : (<span></span>)}
            </div>
            <div className="text-center m-[0.4cm]" style={{display:"inline-block"}}>
            ...
            <div className="text-center m-[0.4cm]" style={{display:"inline-block"}}>
                ...
                {totalStakingReward ? (<div className="text-[#aaa]">{parseFloat(totalStakingReward).toFixed(10)} ULT</div>) : (<span></span>)}
            </div>
            <div className="text-center m-[0.4cm]" style={{display:"inline-block"}}>
