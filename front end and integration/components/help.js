    ...
    return (
        ...
        <div className='text-[#fff] p-[0.5cm] helpinnerdiv'>
         ...
         creation of proposals, view proposal details and voting activities to steer the ecosystem forward. This democratic approach ensures transparency and decentralisation
          in the protocol. The DAO decides tokens used in the Swap, Staking and P2P Lend and Borrow dApps. 
         </div>
         </div>) :
         ...
         <div data-aos="fade-down" className='text-[#eee] ml-[1cm] mt-[0.3cm] text-[90%]'>
          ...
          The NFT gives you access to the DAO. Only users with Ultimum NFT and at least 1,000 ULT can join DAO. For non-members, the process of obtaining the NFT is the page you will see in the DAO section. After obtaining the NFT, 
         ...
         <div data-aos="fade-down" className='text-[#eee] ml-[1cm] mt-[0.3cm] text-[90%]'>
          ...
          means a proposal will be approved. For a seamless user experience, a search functionality and pagination have been integrated into the view proposals section. Voting can also be done from this section 
          by clicking on the upvote or downvote buttons.
         </div>
         </div>) :
         ...
         <div data-aos="fade-down" className='text-[#eee] ml-[1cm] mt-[0.3cm] text-[90%]'>
         Creation of proposals requires you to input a proposal description. Clearly describe your proposal in simple terms for all members to understand. A proposal can be anything ranging from decisions 
         ...
         is a higher number of downvotes, the proposal will not be approved and as such will not be implemented. Voting of proposals can also be done from the "View Proposals" tab.
         </div>
         </div>) : 
         ...
         <Link href="https://github.com/mrpatrick030/Ultimum-DeFi-Protocol-on-Lisk"><button onClick={(e) => setHelp(false)} className='m-[0.2cm] bg-[#502] px-[0.3cm] py-[0.15cm] text-[#fff]'>Docs <img src="images/documentation.png" width="17" className='ml-[0.2cm]' style={{display:"inline-block"}}/></button></Link>
