...
export default function Header(){
  ...
  useEffect(() => {
    ...
    return (
      ...
      <span className='text-[#fff] font-[600]'>DeFi, P2P lend/borrow, DAO, swap, stake protocol on Lisk</span>
      <img src="images/Lisk.png" width="20" className='ml-[0.2cm] rounded-[100%]' style={{display:"inline-block"}} />
      </div>
      </Link>
      ...
      <div className='px-[0.5cm]'>
       ...
       <Link href="https://Lisk.com" onClick={(e) => changemenubehaviour2(e)}><img src="images/Lisk.png" width="23" className='ml-[0.5cm] rounded-[100%]' style={{display:"inline-block"}}/></Link>
       </div>
      </div>
      </div>
      </div>)
