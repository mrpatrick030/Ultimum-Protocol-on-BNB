...
export default function Footer () {
  ...
  const onSubmitForm = async (e) => {
    ...
    <div className='text-center'>
        <div className='text-[#fff] text-[120%] mb-[0.2cm]'>
          <span><span className="font-[500]">Ultimum</span> - The most efficient DeFi protocol on Lisk with a DAO,  P2P lending/borrowing dApp, swap dApp, staking dApp, token and treasury </span>
          <Link href="https://Lisk.io"><img src="images/Lisk.png" width="30" className='ml-[0.3cm] rounded-[100%]' style={{display:"inline-block"}} /></Link>
        </div>
