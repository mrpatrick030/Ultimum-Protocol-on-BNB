...
export default function Dashboard(){
  ...
  return (
   ...
   <div className='w-[100%]'>
   <img src="images/Lisk.png" width="100" className='lg:mt-[10%] mt-[20%] ml-[5%] rounded-[100%] blurimage1' style={{position:"absolute"}} />
   <img src="images/Lisk.png" width="100" className='lg:mt-[15%] mt-[25%] lg:ml-[85%] ml-[65%] rounded-[100%] blurimage2' style={{position:"absolute"}} />
   ...
   <div className='w-[100%] p-[0.5cm] mt-[1cm]' style={{position:"absolute"}}>
    {displayComponent === "mybalances" && (<div id="mybalances" data-aos="zoom-in" className='dashboardcomponent bg-[#111] lg:mx-[2cm] md:mx-[1cm] p-[0.5cm] rounded-xl mb-[1cm]' style={{boxShadow:"2px 2px 2px 2px #502", zIndex:"9999"}}>
      <MyBalancesSection address={address} displayComponent={displayComponent} setDisplayComponent = {setDisplayComponent} changeBg3 = {changeBg3} changeBg4 = {changeBg4} changeBg5 = {changeBg5} changeBg6={changeBg6} changeBg7={changeBg7} />
    </div>)} 
    ...
    <ProtocolMetricsSection address={address} displayComponent={displayComponent} />
    </div>)} 
    {displayComponent === "daogovernance" && (<div id="daogovernance" data-aos="zoom-in" className='dashboardcomponent bg-[#111] lg:mx-[2cm] md:mx-[1cm] p-[0.5cm] rounded-xl mb-[1cm]' style={{boxShadow:"2px 2px 2px 2px #502", zIndex:"9999"}}>
     <UltimumDAOSection address={address} />
    </div>)} 
