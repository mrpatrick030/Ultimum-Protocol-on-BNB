...
export default function Home(){
  ...
  return (
    <>
    <Head>
   <title>Ultimum Protocol - The most efficient protocol on Lisk featuring a DAO, P2P lending/borrowing dApp, swap dApp, Staking dApp, token and treasury</title>
   ...
   <div className='text-center text-[180%] lg:text-[250%] md:text-[200%] pt-[1.5cm] font-[500]'>Mass Adoption of DAO-governed Technologies on Lisk</div>
   ...
   <div className='mt-[1cm] text-center' style={{transition:"0.3s ease-in-out"}}>
    ...
    <Link href="https://github.com/mrpatrick030/Ultimum-DeFi-Protocol-on-Lisk"><button className='m-[0.2cm] rounded-md bg-[#111] px-[0.3cm] py-[0.2cm] text-[#fff] generalbutton docbutton' style={{border:"2px solid #502"}}>Documentation <img src="images/documentation.png" width="25" className='ml-[0.2cm]' style={{display:"inline-block"}}/></button></Link>
   ...
   <div id="ultimumcomponents" className='mt-[2cm]'>
    <div className='grid lg:grid-cols-3 grid-cols-1 gap-4'>
      ...
      <div className='grid-cols-1 lg:col-span-1 col-span-3'>
        ...
        <div className='text-[120%] text-[#fff] font-[600]'>P2P Lending/Borrowing (Decentralised chat integrated)</div>
        <div className='text-[130%] mt-[3%] text-[#eee] font-[500]'>Gain huge rewards for lending to Ultimum</div>
      ...
      <div id="forum" className='mt-[2cm]'>
       ...
       <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-8">
        ...
        the financial results of many products on Lisk.
        </div>
