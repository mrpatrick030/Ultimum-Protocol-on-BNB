...
export default function Header(){
  ...
  useEffect(() => {
    ...
    return (
      ...
      <span className='text-[#fff] font-[600]'>DeFi, P2P lend/borrow, DAO, swap, stake protocol on BNB Smart Chain</span>
      <img src="images/bnb.png" width="20" className='ml-[0.2cm] rounded-[100%]' style={{display:"inline-block"}} />
      </div>
      </Link>
      ...
      <div className='px-[0.5cm]'>
       ...
       <Link href="https://testnet.bscscan.com/" onClick={(e) => changemenubehaviour2(e)}><img src="images/bnb.png" width="23" className='ml-[0.5cm] rounded-[100%]' style={{display:"inline-block"}}/></Link>
       </div>
      </div>
      </div>
      </div>)
