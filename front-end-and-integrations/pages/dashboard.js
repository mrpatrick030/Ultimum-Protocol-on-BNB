  ...
  return (
   ...
   <div>
    ...
    <div className='dashboardmenulg h-[100%] bg-[#111] text-[#fff]' style={{zIndex:"999", position:"fixed", boxShadow:"2px 2px 2px 2px #502", overflow:"auto"}}> 
     <div className='px-[0.5cm] py-[0.6cm] text-center' style={{display:"block"}}>
       ...
       <Link href="https://testnet.bscscan.com/"><img src="images/bnb.png" width="25" className='ml-[0.3cm] rounded-[100%]' style={{display:"inline-block"}}/></Link>
     </div>
      <div>
      ...
      <div className='mt-[30%] p-[0.5cm]' style={{display:"block"}}>
       <div><Link href="https://github.com/mrpatrick030/Ultimum-Protocol-on-BNB"><button className='m-[0.2cm] rounded-md bg-[#502] px-[0.3cm] py-[0.15cm] text-[#fff]'>Docs <img src="images/documentation.png" width="17" className='ml-[0.2cm]' style={{display:"inline-block"}}/></button></Link></div>
   ...
   <div className='w-[70%] h-[100%] bg-[#111] text-[#fff]' data-aos="fade-right" style={{boxShadow:"2px 2px 2px 2px #502", overflow:"auto"}}> 
     <div className='px-[0.5cm] py-[0.6cm] text-center' style={{display:"block"}}>
       ...
       <Link href="https://testnet.bscscan.com/"><img src="images/bnb.png" width="25" className='ml-[0.3cm] rounded-[100%]' onClick={(e) => setMountSmallMenu(false)} style={{display:"inline-block"}}/></Link>
     </div>
      <div>
      ...
      <div className='mt-[20%] p-[0.5cm]' style={{display:"block"}}>
       <div><Link href="https://github.com/mrpatrick030/Ultimum-Protocol-on-BNB"><button onClick={(e) => setMountSmallMenu(false)} className='m-[0.2cm] rounded-md bg-[#502] px-[0.3cm] py-[0.15cm] text-[#fff]'>Docs <img src="images/documentation.png" width="17" className='ml-[0.2cm]' style={{display:"inline-block"}}/></button></Link></div>
   ...
   <div className='w-[100%] p-[0.5cm] mt-[1cm]' style={{position:"absolute"}}>
    {displayComponent === "mybalances" && (<div id="mybalances" data-aos="zoom-in" className='dashboardcomponent bg-[#111] lg:mx-[2cm] md:mx-[1cm] p-[0.5cm] rounded-xl mb-[1cm]' style={{boxShadow:"2px 2px 2px 2px #502", zIndex:"9999"}}>
      <MyBalancesSection displayComponent={displayComponent} setDisplayComponent = {setDisplayComponent} changeBg3 = {changeBg3} changeBg4 = {changeBg4} changeBg5 = {changeBg5} changeBg6={changeBg6} changeBg7={changeBg7} />
    </div>)} 
    ...
    <ProtocolMetricsSection displayComponent={displayComponent} />
    </div>)} 
    ...
    {displayComponent === "borrow" && (<div id="borrow" data-aos="zoom-in" className='dashboardcomponent bg-[#111] lg:mx-[2cm] md:mx-[1cm] p-[0.5cm] rounded-xl mb-[1cm]' style={{boxShadow:"2px 2px 2px 2px #502", zIndex:"9999"}}>
      <BorrowSection displayComponent={displayComponent} setDisplayComponent={setDisplayComponent} changeBg6={changeBg6} />
    </div>)} 
   </div>
   </div>
