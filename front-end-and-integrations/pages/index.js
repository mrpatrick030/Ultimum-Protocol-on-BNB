...
export default function Home(){
  ...
  return (
    <>
    <Head>
   <title>Ultimum Protocol - The most efficient protocol on BNB Smart Chain featuring a DAO, P2P lending/borrowing dApp, swap dApp, Staking dApp, token and treasury</title>
   ...
   <div className='text-center text-[180%] lg:text-[250%] md:text-[200%] pt-[1.5cm] font-[500]'>Mass Adoption of DAO-governed Technologies on BNB Smart Chain</div>
   <div className='mt-[1cm] text-center lg:text-[140%] text-[120%] lg:mx-[20%] md:mx-[10%] mx-[5%] p-[1cm] lg:px-[2cm] text-[#ccc] bg-[rgba(0,0,0,0.9)]' style={{border:"1px solid #502"}}>
    ...
    Ultimum DAO: Ultimum protocol users can participate in governance by using the DAO as a potent tool. This includes, but is not limited to, making decisions, submitting proposals,
     viewing proposal details, and voting to move the protocol forward. Decentralisation and transparency in the ecosystem are guaranteed by this democratic method.
    ...
    Lending on Ultimum yields substantial interest rewards. Our lending/borrowing dApp is designed to be user-friendly with a decentralised chat system and search functionalities and paginations.
    ...
    <div data-aos="fade-in" className='info3' style={{transition:"0.5s ease-in-out"}}>
      Swap dApp: With a ChainLink and RedStone Oracle integration and user-first approach, our users experience decentralized finance and can therefore use the Ultimum Protocol swap dApp to swap a variety of 
   ...
   <div className='mt-[1cm] text-center' style={{transition:"0.3s ease-in-out"}}>
    ...
    <Link href="https://github.com/mrpatrick030/Ultimum-Protocol-on-BNB"><button className='m-[0.2cm] rounded-md bg-[#111] px-[0.3cm] py-[0.2cm] text-[#fff] generalbutton docbutton' style={{border:"2px solid #502"}}>Documentation <img src="images/documentation.png" width="25" className='ml-[0.2cm]' style={{display:"inline-block"}}/></button></Link>
   ...
   <div id="ultimumcomponents" className='mt-[2cm]'>
    <div className='grid lg:grid-cols-3 grid-cols-1 gap-4'>
      ...
      <div className='lg:h-[15.85cm] h-[7cm] rounded-xl lg:p-[1cm] p-[0.5cm] homepageswapdiv' style={{backgroundImage:"url(images/ultimumswap.jpg)", boxShadow:"2px 2px 10px 1px #502"}}>
        <div className='lg:text-[200%] text-[130%] lg:mt-[10%] mt-[3%] text-[#fff] font-[500]'>Swap on BNB Smart Chain<br /><span className='lg:text-[70%] text-[60%] text-[#ccc]'>(ChainLink Oracles integrated)</span></div>
        <div className='lg:text-[250%] md:text-[200%] text-[130%] mt-[3%] text-[#eee] font-[500]'>Live Now</div>
        <Link href="/dashboard"><button className='lg:mt-[10%] mt-[3%] rounded-md bg-[#111] px-[0.3cm] py-[0.1cm] text-[#fff] generalbutton2' style={{border:"2px solid #502"}}>Swap tokens</button></Link>
      </div>
      </div>
      <div className='grid-cols-1 lg:col-span-1 col-span-3'>
        ...
        <div className='lg:text-[120%] text-[#fff] font-[600]'>P2P Lending/Borrowing (Decentralised chat integrated)</div>
        <div className='lg:text-[130%] mt-[3%] text-[#eee] font-[500]'>Gain huge rewards for lending on Ultimum</div>
        <Link href="/dashboard"><button className='mt-[3%] rounded-md bg-[#111] px-[0.3cm] py-[0.1cm] text-[#fff] generalbutton2' style={{border:"2px solid #502"}}>Lend/borrow</button></Link>
        </div>
        ...
        <div className='lg:text-[120%] text-[#fff] font-[600]'>Ultimum DAO</div>
        <div className='lg:text-[130%] mt-[3%] text-[#fff] font-[500]'>Engage in decentralised democratic governance</div>
        <Link href="/dashboard"><button className='mt-[3%] rounded-md bg-[#111] px-[0.3cm] py-[0.1cm] text-[#fff] generalbutton2' style={{border:"2px solid #502"}}>Enter DAO</button></Link>
        </div>
        ...
        <div className='lg:text-[120%] text-[#fff] font-[600]'>Time-frame (stake)</div>
        <div className='lg:text-[130%] mt-[3%] text-[#eee] font-[500]'>Earn smart money while having full flexibility for your tokens</div>
        <Link href="/dashboard"><button className='mt-[3%] rounded-md bg-[#111] px-[0.3cm] py-[0.1cm] text-[#fff] generalbutton2' style={{border:"2px solid #502"}}>Stake tokens</button></Link>
        </div>
        </div>
      </div>
    </div>
      ...
      <div id="forum" className='mt-[2cm]'>
       ...
       <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-8">
        ...
        <div className="lg:text-[120%] md:text-[110%] text-[100%] mt-[5%]"> 
        With a robust reward system, Ultimum aims to reward users according to their usage of the platform. $ULT is rewarded for lending, staking and contributions to the governance 
        of the Ultimum DAO. Users can aslo earn $ULT in potential airdrops organised by the protocol in the future. To learn more about the reward system, visit the Ultimum forum below.
        </div>
        <div className="mt-[5%]">
        ...
        <div className="m-[auto]"><img src="images/bnbresource.png" width="70"/></div>
        ...
        the financial results of many products on BNB Smart Chain.
        </div>
