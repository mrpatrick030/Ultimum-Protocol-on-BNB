...
export default async function handler(req, res) {
  ...
  try {
    ...
    const emailCheckQuery = 'SELECT * FROM ultimumbnbadmin WHERE email = $1';
    ...
    const insertQuery = 'INSERT INTO ultimumbnbadmin (username, email, password, gender) VALUES ($1, $2, $3, $4)';
