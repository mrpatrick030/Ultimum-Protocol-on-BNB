...
export default function Footer () {
  ...
  const onSubmitForm = async (e) => {
    ...
    <div className='grid-cols-1 m-[auto]'>
      ...
      <Link href="https://web3bridge.com"><img src="images/web3bridge.png" width="40" className='m-[0.2cm] generalbutton4' style={{display:"inline-block"}} /></Link>
      <Link href="https://chain.link"><img src="images/chainlink.png" width="40" className='m-[0.2cm] generalbutton4' style={{display:"inline-block"}} /></Link>
      <Link href="https://tradingview.com"><img src="images/tradingview.png" width="40" className='m-[0.2cm] generalbutton4' style={{display:"inline-block"}} /></Link>
      <Link href="https://openzeppelin.com"><img src="images/openzeppelin.png" width="40" className='m-[0.2cm] generalbutton4' style={{display:"inline-block"}} /></Link>
    </div>
    </div>
    <div className='mb-[1cm]' style={{borderBottom:"2px solid #502"}}></div>
    <div className='text-center'>
        <div className='text-[#fff] text-[120%] mb-[0.2cm]'>
          <span><span className="font-[500]">Ultimum</span> - The most efficient DeFi protocol on BNB Smart Chain with a DAO,  P2P lending/borrowing dApp, swap dApp, staking dApp, token and treasury </span>
          <Link href="https://BNB Smart Chain.io"><img src="images/bnb.png" width="30" className='ml-[0.3cm] rounded-[100%]' style={{display:"inline-block"}} /></Link>
        </div>
