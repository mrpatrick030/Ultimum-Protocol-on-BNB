...
export default function Help({setHelp, instruction1, instruction2, instruction3, instruction4, instruction5, setInstruction1, setInstruction2, setInstruction3, setInstruction4, setInstruction5}) {
    ...
    return (
        ...
        <div className='text-[#fff] p-[0.5cm] helpinnerdiv'>
         ...
         <Link href="https://github.com/mrpatrick030/Ultimum-Protocol-on-BNB"><button onClick={(e) => setHelp(false)} className='m-[0.2cm] bg-[#502] px-[0.3cm] py-[0.15cm] text-[#fff]'>Docs <img src="images/documentation.png" width="17" className='ml-[0.2cm]' style={{display:"inline-block"}}/></button></Link>
